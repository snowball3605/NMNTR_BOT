...
public class JoinAndLeaveMain {
    ...
    public void onLeave(GuildMemberRemoveEvent event) {
        ...
        guild.getTextChannelById("1001830506582782022").sendMessageEmbeds(eb.build()).queue();
    }
    ...
    public static void onMessage(MessageReceivedEvent event) {
        ...
        if (Step.step == 4) {
            ...
            guild.getTextChannelById("1001814301989949540").sendMessage(guild.getRoleById("825203834455588866").getAsMention()).queue();
            ...
            guild.getTextChannelById("1001814301989949540").sendMessageEmbeds(Step.b.build())
                    .setActionRow(Button.success("00004", "允許加入"), (Button.danger("00005", "拒絕加入"))).queue();
            guild.getTextChannelById("995655746622586971").sendMessageEmbeds(Step.b.build()).queue();
