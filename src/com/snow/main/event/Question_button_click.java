    ...
    public void onButtonClick(ButtonInteractionEvent event) {
      ...
      String member = event.getMember().getUser().getName();
        if (event.getButton().getId().equals("00000")) {
                    event.getGuild().createTextChannel("ticket-" + member, event.getGuild().getCategoryById("995604920625537037"))
    ...
    public void onButtonClick2(ButtonInteractionEvent event) {
        ...
        try {
            if (event.getButton().getId().equals("00004")) {
                Role role = guild.getRoleById("825607310084014081");
                assert role != null;
                ...
                guild.getTextChannelById("1001814301989949540").deleteMessageById(guild.getTextChannelById("1001814301989949540").getLatestMessageId()).queue();
                guild.getTextChannelById("1001814301989949540").sendMessage(event.getMember().getUser().getName()+"已處理"+ JoinAndLeaveMain.Step.member1.getUser().getName()+"\n結果:接受").queue();
                guild.getTextChannelById("995655746622586971").sendMessage(event.getMember().getUser().getName()+"已處理"+ JoinAndLeaveMain.Step.member1.getUser().getName()+"\n結果:接受").queue();
